...
/**
 * This is decompiled code of CDE XML Dump original version.
 * This code is used as a start point for the currently used class XMLGeneratorBean.
 *
 */
public class XMLGeneratorBeanOld {
